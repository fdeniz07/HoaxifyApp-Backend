package com.hoaxify.ws.shared.utils;
...
public class ErrorMessages {
    ...
    public static final String USERNAME_IS_INVALID = "Error : Username is invalid. Please enter valid a username";
    public static final String VALIDATION_ERROR = "Error : Validation error!";
